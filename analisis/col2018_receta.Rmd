...
author: "[Nelson Amaya](https://twitter.com/NelsonAmayaD)"
...
<br>
<br>
Este es un ejercicio dinámico sobre las encuestas de intención de voto para las elecciones presidenciales de Colombia en 2018. Combina tres cosas chéveres: estadística bayesiana, reproducibilidad y computación open-source. Tiene la aspiración de ser una versión amateur de una de las cosas que más me han gustado de los últimos años: [esto de Pierre-Antoine Kremp  para las elecciones en EEUU de 2016](https://pkremp.github.io/report.html). 

Acá se pone todo sobre la mesa. Hacer las cosas así permite que cualquiera pueda estimar el modelo, escudriñarlo, criticarlo y, ojalá, formular uno mejor. Seguramente está lleno de errores, así que haré todo lo posible por corregirlos conforme vayan apareciendo.

Ya que los resultados se pueden interpretar como un pronóstico electoral, este reporte va en reversa. Primero el plato (los resultados), después los ingredientes (datos), luego la receta (modelo), y al final la preparación en la cocina (código). 
...
Los datos básicos de las encuestas se pueden importar desde GitHub con RCurl (ver abajo). Las tendencias en las encuestas se ven mejor [acá](https://nelsonamayad.shinyapps.io/col2018_tend/).
...
Esta perspectiva tiene muchas limitaciones. Las dos más importantes: no modela la determinación simultánea de la votación para todos los candidatos, ni el sesgo de respuesta de las encuestas. Ambas se pueden hacer pero por ahora quedan en el tintero. 
